...
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Bread crumbs', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Butter', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Chocolate', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Chopped almonds', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Cinnamon', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Egg whites', 500000, 'ml', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Eggs', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Fine-ground nuts', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Flour', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Ground, roasted nuts', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Icing sugar', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Marzipan', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Potato starch', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Roasted, chopped nuts', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Sodium bicarbonate', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Sugar', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Vanilla', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Vanilla sugar', 500000, 'g', curdate(), 500000);
INSERT into RawMaterials(name, amount, unit, last_bought_date, last_bought_amount) VALUES ('Wheat flour', 500000, 'g', curdate(), 500000);
delete from Cookies;
